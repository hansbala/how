...
const MODEL_BYTES: &[u8] =
    include_bytes!("../model_resources/qwen2.5-coder-0.5b-instruct-q4_k_m.gguf");
...
fn main() -> Result<()> {
    ...
    // Create Context
    let ctx_params = LlamaContextParams::default().with_n_ctx(NonZeroU32::new(1024)); // Increased context slightly for the longer prompt
